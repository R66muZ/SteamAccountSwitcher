...
echo               O---o                                                       O---o
echo              O-----o      B) Back  C) Cycle colors  P) Reinstall program O-----o
echo              o-----O                                                     o-----O
echo               o---O o O       o O       o O       o O       o O       o O o---O
echo                o-Oo ^| ^| O   o ^| ^| O   o ^| ^| O   o ^| ^| O   o ^| ^| O   o ^| ^| Oo-O
echo                 O ^| ^| ^| ^| O ^| ^| ^| ^| O ^| ^| ^| ^| O ^| ^| ^| ^| O ^| ^| ^| ^| O ^| ^| ^| ^| O
...
if not exist "%appdata%\SteamAccountSwitcher\SASData.txt" (type nul >"%appdata%\SteamAccountSwitcher\SASData.txt" & echo  %ESC%[94mFILE%ESC%[0m: Creating SASData.txt) else (echo  %ESC%[94mFILE%ESC%[0m: SASData.txt already exists.)
